...
public class CameraHelper implements Camera.PreviewCallback {
    ...
    public void start() {
        synchronized (this) {
                ...
                Log.i("MSG",  "相机总数是"+ Camera.getNumberOfCameras());
   ...
   //设置相机位置
    ...
    public void onPreviewFrame(byte[] nv21, Camera camera) {
        if (cameraListener != null) {
            cameraListener.onPreview(nv21, camera); //获取视频流
        }
    }
    ...
    public static final class Builder {
         ...
         * 事件回调
         */
        private CameraListener cameraListener; //RegisterAnd 设置回调事件
        /**
         * 屏幕的长宽，在选择最佳相机比例时用到
         */
        private Point previewViewSize;
